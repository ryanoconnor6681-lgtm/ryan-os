...
const allProjects = [
  {
    ...
    groups: [
      ...
      },
      {
        ...
        images: ['/images/curio/curiosity2.png'],
      },
    ],
  ...
  {
    id: 'cvts',
    tags: ['experience', 'leadership', 'strategy', 'nike', 'innovation', 'ai'],
    type: 'case_study',
    title: 'Nike CVTS',
    client: 'NIKE',
    role: 'VP Creative & Innovation',
    date: '2026',
    category: 'Experience',
    ...
    images: [
      ...
      '/images/cvts/detail_04.jpg',
      '/images/cvts/detail_05.jpg',
    ],
    groups: [
      {
        ...
        size: 'small',
        images: [
          '/images/cvts/detail_06.jpg',
          '/images/cvts/detail_07.jpg',
          '/images/cvts/detail_08.jpg',
          '/images/cvts/detail_09.jpg',
          '/images/cvts/detail_10.jpg',
          '/images/cvts/detail_11.jpg',
          '/images/cvts/detail_12.jpg',
          '/images/cvts/detail_13.jpg',
          '/images/cvts/detail_14.jpg',
        ],
      },
      {
        name: 'From concept to build',
        size: 'small',
        images: [
          '/images/cvts/concept_01.jpg',
          '/images/cvts/concept_02.jpg',
          '/images/cvts/concept_03.jpg',
          '/images/cvts/concept_04.jpg',
          '/images/cvts/concept_05.jpg',
          '/images/cvts/concept_06.jpg',
        ],
      },
    ],
